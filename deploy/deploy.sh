...
ENVIRONMENT_NAME=internal-launchrock-test-test-$ENVIRONMENT
SERVICE_ROOT=$PROJECT_PATH/$SERVICE_PATH
DOCKERFILE=$SERVICE_ROOT/$DOCKERFILE_PATH
SERVICE_NAME=internal-launchrock-test-test-$SERVICE
SERVICE_TAG=$SERVICE_NAME:$TAG
SERVICE_URL=569325332953.dkr.ecr.us-east-1.amazonaws.com/$SERVICE_TAG
SECRET_NAME=internal-launchrock-test-test-$SERVICE-secrets
CONFIGMAP_NAME=internal-launchrock-test-test-$SERVICE-configmap
